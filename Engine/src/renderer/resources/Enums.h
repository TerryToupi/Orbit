...
namespace Engine
{
	...
	{
		COMMAND_BUFFER_STATE_READY = 0x0,
		COMMAND_BUFFER_STATE_RECORDING = 0x1,
		COMMAND_BUFFER_STATE_IN_RENDER_PASS = 0x2,
		COMMAND_BUFFER_STATE_RECORDING_ENDED = 0x4,
		COMMAND_BUFFER_STATE_SUBMITTED = 0x8,
		COMMAND_BUFFER_STATE_NOT_ALLOCATED = 0x10,
	};
}
